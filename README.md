...
| **الفئة**              | **الدالة**     | **الوصف**                                                                        | **مثال** |
|------------------------|----------------|----------------------------------------------------------------------------------|----------|
| **طرق تغيير حالة الأحرف**  | `capitalize()` | تحويل الحرف الأول إلى حرف كبير                                                  | ```python<br>text = "hello WORLD"<br>print(text.capitalize())  # Output: Hello world``` |
|                        | `upper()`      | تحويل جميع الأحرف إلى أحرف كبيرة                                                 | ```python<br>print(text.upper())  # Output: HELLO WORLD```     |
|                        | `lower()`      | تحويل جميع الأحرف إلى أحرف صغيرة                                                 | ```python<br>print(text.lower())  # Output: hello world```     |
|                        | `title()`      | تحويل الحرف الأول من كل كلمة إلى حرف كبير                                        | ```python<br>print(text.title())  # Output: Hello World```     |
|                        | `swapcase()`   | تبادل حالة الأحرف: الحروف الصغيرة تصبح كبيرة والعكس صحيح                        | ```python<br>print(text.swapcase())  # Output: HELLO world```  |
| **طرق البحث والتحقق**  | `startswith()` | تتحقق مما إذا كانت السلسلة تبدأ بنص معين                                         | ```python<br>filename = "document.txt"<br>print(filename.startswith("doc"))  # Output: True``` |
|                        | `endswith()`   | تتحقق مما إذا كانت السلسلة تنتهي بنص معين                                        | ```python<br>print(filename.endswith(".pdf"))  # Output: False``` |
|                        | `find()`       | تبحث عن نص معين وتعيد موقعه (أو -1 إذا لم يتم العثور عليه)                      | ```python<br>print(filename.find("ment"))  # Output: 4``` |
|                        | `index()`      | مشابهة لـ `find()`، ولكنها ترفع استثناء إذا لم يتم العثور على النص             | ```python<br>print(filename.index("txt"))  # Output: 9``` |
|                        | `rfind()`      | البحث عن قيمة معينة وإعادة آخر موضع لها                                          | ```python<br>print(filename.rfind("c"))  # Output: 2``` |
|                        | `rindex()`     | البحث عن قيمة معينة وإعادة آخر موضع لها                                          | ```python<br>print(filename.rindex("c"))  # Output: 2``` |
| **طرق التنسيق والتعديل** | `strip()`      | تزيل المسافات والأسطر الجديدة من بداية ونهاية السلسلة                           | ```python<br>text = "  Python is awesome  "<br>print(text.strip())  # Output: Python is awesome``` |
|                        | `lstrip()`     | تزيل المسافات من بداية السلسلة                                                  | ```python<br>print(text.lstrip())  # Output: Python is awesome``` |
|                        | `rstrip()`     | تزيل المسافات من نهاية السلسلة                                                  | ```python<br>print(text.rstrip())  # Output:   Python is awesome``` |
|                        | `replace()`    | تستبدل نصًا بنص آخر                                                             | ```python<br>print(text.replace("awesome", "great"))  # Output:   Python is great``` |
|                        | `split()`      | تقسم السلسلة إلى قائمة بناءً على فاصل معين                                      | ```python<br>print("Hello,World".split(","))  # Output: ['Hello', 'World']``` |
|                        | `splitlines()` | تقسم السلسلة النصية عند فواصل الأسطر                                             | ```python<br>print("Hello\nWorld".splitlines())  # Output: ['Hello', 'World']``` |
|                        | `join()`       | تدمج عناصر قائمة في سلسلة نصية واحدة                                            | ```python<br>print("-".join(["Python", "3", "9"]))  # Output: Python-3-9``` |
|                        | `zfill()`      | ملء السلسلة النصية بعدد محدد من القيم 0 في البداية                               | ```python<br>print("42".zfill(5))  # Output: 00042``` |
|                        | `expandtabs()` | تحديد حجم علامة التبويب في السلسلة النصية                                       | ```python<br>print("Hello\tWorld".expandtabs(4))  # Output: Hello   World``` |
|                        | `center()`     | إعادة سلسلة نصية متمركزة                                                        | ```python<br>print("Python".center(10, "*"))  # Output: **Python**``` |
|                        | `ljust()`      | إعادة نسخة من السلسلة النصية بمحاذاة إلى اليسار                                  | ```python<br>print("Python".ljust(10, "-"))  # Output: Python----``` |
|                        | `rjust()`      | إعادة نسخة من السلسلة النصية بمحاذاة إلى اليمين                                  | ```python<br>print("Python".rjust(10, "-"))  # Output: ----Python``` |
| **طرق التحقق من المحتوى** | `isalpha()`    | تتحقق مما إذا كانت جميع الأحرف أبجدية                                            | ```python<br>print("abc".isalpha())  # Output: True``` |
|                        | `isdigit()`    | تتحقق مما إذا كانت جميع الأحرف أرقامًا                                           | ```python<br>print("123".isdigit())  # Output: True``` |
|                        | `isalnum()`    | تتحقق مما إذا كانت جميع الأحرف أبجدية رقمية                                      | ```python<br>print("abc123".isalnum())  # Output: True``` |
|                        | `islower()`    | تتحقق مما إذا كانت جميع الأحرف صغيرة                                             | ```python<br>print("abc".islower())  # Output: True``` |
|                        | `isupper()`    | تتحقق مما إذا كانت جميع الأحرف كبيرة                                             | ```python<br>print("ABC".isupper())  # Output: True``` |
|                        | `isascii()`    | تتحقق مما إذا كانت جميع الأحرف أحرف ASCII                                        | ```python<br>print("Hello".isascii())  # Output: True``` |
|                        | `isdecimal()`  | تتحقق مما إذا كانت جميع الأحرف أرقام عشرية                                       | ```python<br>print("12345".isdecimal())  # Output: True``` |
|                        | `isnumeric()`  | تتحقق مما إذا كانت جميع الأحرف أرقام                                             | ```python<br>print("12345".isnumeric())  # Output: True``` |
|                        | `isidentifier()` | تتحقق مما إذا كانت السلسلة النصية معرفًا صالحًا                                 | ```python<br>print("myVar".isidentifier())  # Output: True``` |
|                        | `isprintable()` | تتحقق مما إذا كانت جميع الأحرف قابلة للطباعة                                     | ```python<br>print("Hello, World!".isprintable())  # Output: True``` |
|                        | `isspace()`    | تتحقق مما إذا كانت جميع الأحرف مسافات                                            | ```python<br>print("   ".isspace())  # Output: True``` |
|                        | `istitle()`    | تتحقق مما إذا كانت السلسلة النصية تتبع قواعد العنوان                             | ```python<br>print("Hello World".istitle())  # Output: True``` |
| **طرق التنسيق والتعديل المتقدمة** | `format()`     | تنسيق القيم المحددة في السلسلة النصية                                          | ```python<br>age = 36<br>txt = "My name is John, I am {}"<br>print(txt.format(age))  # Output: My name is John, I am 36``` |
|                        | `format_map()` | تنسيق القيم المحددة في السلسلة النصية باستخدام خريطة                            | ```python<br>person = {'name': 'John', 'age': 36}<br>txt = "My name is {name}, I am {age}"<br>print(txt.format_map(person))  # Output: My name is John, I am 36``` |
|                        | `maketrans()`  | إعادة جدول ترجمة لاستخدامه في الترجمات                                         | ```python<br>txt = "Hello, World!"<br>trans = txt.maketrans("H", "J")<br>print(txt.translate(trans))  # Output: Jello, World!``` |
|                        | `translate()`  | إعادة سلسلة نصية مترجمة                                                        | ```python<br>print(txt.translate(trans))  # Output: Jello, World!``` |
|                        | `partition()`  | إعادة قيمة مكونة من ثلاثة أجزاء حيث تنقسم السلسلة النصية                        | ```python<br>txt = "I could eat bananas all day"<br>print(txt.partition("bananas"))  # Output: ('I could eat ', 'bananas', ' all day')``` |
|                        | `rpartition()` | إعادة قيمة مكونة من ثلاثة أجزاء حيث تنقسم السلسلة النصية من النهاية             | ```python<br>print(txt.rpartition("bananas"))  # Output: ('I could eat ', 'bananas', ' all day')``` |
